...
*See [component-list.md](component-list.md) for component responsibilities.*  
*See [../decisions/ADR-006-artifact-graph-model.md](../decisions/ADR-006-artifact-graph-model.md) for the graph model decision.*
