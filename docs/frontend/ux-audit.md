...
- The UI (via Zustand) must intercept the delete action, check for dependencies locally, and present a warning modal *before* making the IPC call.
- *Example:* "Cannot delete 'User Auth Requirement'. It has 3 dependent Tasks. Delete or reassign the tasks first."
